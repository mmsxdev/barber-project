          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className={`${
              isDarkMode
                ? "bg-slate-800/50"
                : "bg-white"
            } p-8 rounded-2xl shadow-xl border border-gray-200/20`}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6" aria-label="Formulário de contato">
                ...
                <button
                  type="submit"
                  className="w-full bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg transition-all shadow-lg shadow-green-500/20 font-medium focus:ring-2 focus:ring-offset-2 focus:ring-green-500 flex items-center justify-center gap-2 text-lg"
            ...
            <div className={`${
              isDarkMode
                ? "bg-slate-800/50"
                : "bg-white"
            } p-8 rounded-2xl shadow-xl border border-gray-200/20 space-y-8`}>
              ...
              <div className="pt-6 border-t border-gray-200/20">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="p-3 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg"
                  ...
                  <a
                    href="#"
                    className="p-3 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:from-pink-600 hover:to-purple-700 transition-all shadow-lg"
                  ...
                  <a
                    href="#"
                    className="p-3 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 text-white hover:from-blue-500 hover:to-blue-600 transition-all shadow-lg"
